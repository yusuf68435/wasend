...
export function SkeletonLine({
  ...
  return (
    <div
      className={`h-4 bg-[#f5f5f7] rounded animate-pulse ${className}`}
      style={{ width }}
      aria-hidden="true"
    />
  );
...
export function SkeletonCard({ className = "" }: { className?: string }) {
  return (
    <div
      ...
      aria-hidden="true"
    >
      <div className="h-4 w-24 bg-[#f5f5f7] rounded animate-pulse mb-3" />
      <div className="h-8 w-16 bg-[#f5f5f7] rounded animate-pulse" />
    </div>
  );
}
      ...
      {Array.from({ length: rows }).map((_, i) => (
        ...
        >
          ...
          <div className="flex-1 space-y-2">
            <div className="h-3 w-1/3 bg-[#f5f5f7] rounded animate-pulse" />
            <div className="h-3 w-1/2 bg-[#f5f5f7] rounded animate-pulse" />
          </div>
          <div className="w-16 h-6 bg-[#f5f5f7] rounded animate-pulse" />
        </div>
      ))}
    </div>
  );
